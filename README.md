# NEW HIS系統-診所營運流程整合系統 Demo V11

## V11 更新

- 患者管理從入口按鈕升級成可填寫、可儲存、可查詢的流程。
- 新增 patient_events 患者事件紀錄表。
- 支援新增個案、初診建檔、複診登記、客服關懷、居家諮詢與列管事項。
- 患者檔案可查看事件紀錄。
- 新增列管／客服／居家紀錄時，可同步建立待辦任務。
...
# NRS 診所營運流程整合系統 Demo V11：OpenAI + 月排班版
